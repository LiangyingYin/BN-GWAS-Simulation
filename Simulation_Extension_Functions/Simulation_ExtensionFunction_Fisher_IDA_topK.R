#***************************************************************************************************
# Aim of this function is to compare the IDA and univariate test based on imputed gene expression data 
# with TopK genes
#***************************************************************************************************
# @ - dt_IDA: the results of estimated IDA or joint IDA 
# @ - topK_percent: percentage for selecting the genes for comparison
#***************************************************************************************************
...
#***************************************************************************************************
# Aim of this function is to compare the IDA and estimated IDA based on our method
# with TopK genes
#***************************************************************************************************
# @ - dt_IDA: the results of estimated IDA or joint IDA 
# @ - topK_percent: percentage for selecting the genes for comparison
...
#***************************************************************************************************
# Aim of this function is to compare the joint IDA and univariate test based on imputed gene expression data 
# with TopK genes
#***************************************************************************************************
# @ - dt_IDA: the results of estimated IDA or joint IDA 
# @ - topK_percent: percentage for selecting the genes for comparison
...
#***************************************************************************************************
# Aim of this function is to compare the jointIDA and estimated jointIDA based on our method
# with TopK genes
#***************************************************************************************************
# @ - dt_IDA: the results of estimated IDA or joint IDA 
# @ - topK_percent: percentage for selecting the genes for comparison
...
#***************************************************************************************************
# Aim of this function is to compare the trueIDA and estimated IDA based on our method
# with TopK genes
#***************************************************************************************************
# @ - dt_IDA: the results of estimated IDA or joint IDA 
# @ - topK_percent: percentage for selecting the genes for comparison
...
#***************************************************************************************************
# Aim of this function is to compare the true jointIDA and estimated jointIDA based on our method
# with TopK genes
#***************************************************************************************************
# @ - dt_IDA: the results of estimated IDA or joint IDA 
# @ - topK_percent: percentage for selecting the genes for comparison
...
#***************************************************************************************************
# Aim of this function is to caculate the mean of results from fisher test
# with TopK genes
#***************************************************************************************************
# @ - list_fisher_result: the results of fisher test based on different top K genes
#***************************************************************************************************
...
#***************************************************************************************************
# Aim of this function is to caculate the median of results from fisher test
# with TopK genes
#***************************************************************************************************
# @ - list_fisher_result: the results of fisher test based on different top K genes
#***************************************************************************************************
...
#***************************************************************************************************
# Aim of this function is to estimate the IDA and jointIDA based on the estimated causal graph
#***************************************************************************************************
# @ - tureGraph: the simulated true graph
# @ - cov_imputedExpr: covariance matrix based on imputed gene expression data
# @ - result_list: results from PC algorithm after bootstrap
# @ - pcSimple.fit: results from pc simple algorithm
# @ - genes_num: thenumber of genes when learning gene-pheno network
# @ - pc.fit: estimated gene-pheno network based on our method
#***************************************************************************************************
...
#***************************************************************************************************
# Aim of this function is to estimate the IDA and jointIDA based on the estimated causal graph
# with different settings of covariance matrix
#***************************************************************************************************
# @ - tureGraph: the simulated true graph
# @ - cov_rowExpr: covariance matrix based on raw gene expression data
# @ - cov_imputedExpr: covariance matrix based on imputed gene expression data
# @ - result_list: results from PC algorithm after bootstrap
# @ - pcSimple.fit: results from PC-simple algorithm
# @ - genes_num: the number of genes when learning gene-pheno network
# @ - pc.fit: estimated gene-pheno network based on our method
#***************************************************************************************************
Get_dtIDA2 <- function(tureGraph,cov_rowExpr,cov_imputedExpr,result_list,pcSimple.fit,genes_num,pc.fit)
{
  ...
  #Updated on 2023.8.19 by fyn. This is because we used the default value of all.pasets,but now it seems that we need to set it manually
  true_jointIDA_list = jointIda(x.pos=x.pos,y.pos=y.pos,covTrue,covTrue,graphEst=tureGraph,technique="RRC",all.pasets = NULL)
  
  
  #estimate_jointIDA_list = jointIda(x.pos=x.pos,y.pos=y.pos,cov(dat2),graphEst=estimateGraph,technique="RRC")
  # estimate_jointIDA_list = jointIda(x.pos=x.pos,y.pos=y.pos,cov_rowExpr,cov_imputedExpr,graphEst = pc.fit,technique="RRC")
  estimate_jointIDA_list = jointIda(x.pos=x.pos,y.pos=y.pos,cov_rowExpr,cov_imputedExpr,graphEst = pc.fit,technique="RRC",all.pasets = NULL)
