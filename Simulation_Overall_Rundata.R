#***************************************************************************************************
# This is the code for applying our framework in simulated data
#***************************************************************************************************
# Load the source code and function code
# /opt/R-3.6.1/bin/R
FOLDER_PATH = "/exeh_4/yaning_feng/04_Simulation/R_Package/" # Please amend this path to your local path
...
source(paste0(FOLDER_PATH,"Simulation_Extension_Functions/Simulation_ExtensionFunction_GraphAccuracy.R"))
...
######################################################################################
# Please ensure that you have installed these packages before running the code
library(pcalg)
library(CePa)
library(reshape2)
library(data.table)
...
eMat_g_tmp_rnorm_sd = 2  # sd in gene expression data 
