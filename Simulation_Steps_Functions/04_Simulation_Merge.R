#***************************************************************************************************
# Aim of this function is merge the gene-gene network and gene-pheno network
#***************************************************************************************************
# @ - pcSimple.fit: results of gene-pheno network, learned by PC-Simple algorithm
# @ - graph_est: results of gene-gene network, learned by PC algorithm
#***************************************************************************************************
