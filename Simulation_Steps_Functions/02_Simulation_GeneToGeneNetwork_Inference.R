#***************************************************************************************************
# Aim of this function is to apply the PC Algorithm to learn the gene-gene causal network
#***************************************************************************************************
# @ - samples_data_bootstrap: samples for learning gene-gene causal network
#***************************************************************************************************
...
#***************************************************************************************************
# Aim of this function is to apply the PC Algorithm to learn the gene-gene causal network 
# with the strategy of lasso
#***************************************************************************************************
# @ - cov_mat: Covariance matrix of gene-gene expression data
#***************************************************************************************************
...
#***************************************************************************************************
# Aim of this function is to apply the bootstrap strategy to PC Algorithm 
#***************************************************************************************************
# @ - samples_data_bootstrap: samples for learning gene-gene network
# @ - times_bootstrap: setting the times for bootstrap
# @ - cut_off: cut off number for selecting the edges after applying bootstrap to PC Algorithm
#***************************************************************************************************
